            ...
            <div className="row ">
              ...
              <p className='filter col-6'>
                <button onClick={showFilter}>
                  <i class="fas fa-light fa-sliders filter_icon" />  {Translations(props?.langData, props?.selected_lang, 'FiltroLabel')}
                </button>
              </p>
                ...
                <Link data-aos="fade-right" data-aos-duration="1000" className=" col-md-6 col-12 singleCard" to={el?.pageUniqueURL}>
                  ...
                  <div className="image_info">
                    ...
                    <div className="cardText mb-3 ">
                      <i className="fas fa-map-marker-alt  " aria-hidden="true" /> &nbsp;{el?.location}
                    </div>
                  </div>
                </Link>
              )
